 ...
 */
@Value.Enclosing
public class MyAggregateCaseToFilterRule
        extends RelRule<MyAggregateCaseToFilterRule.Config>
        implements SubstitutionRule {

    public static final MyAggregateCaseToFilterRule INSTANCE = Config.DEFAULT.toRule();


    /** Creates an AggregateCaseToFilterRule. */
    protected MyAggregateCaseToFilterRule(Config config) {
        super(config);
    }
    ...
    protected MyAggregateCaseToFilterRule(RelBuilderFactory relBuilderFactory,
                                        String description) {
...
//                && SqlTypeName.INT_TYPES.contains(rexNode.getType().getSqlTypeName())
    ...
    public interface Config extends RelRule.Config {
        Config DEFAULT = ImmutableMyAggregateCaseToFilterRule.Config.of()
                .withOperandSupplier(b0 ->
                        b0.operand(Aggregate.class).oneInput(b1 ->
                                b1.operand(Project.class).anyInputs()));


        @Override default MyAggregateCaseToFilterRule toRule() {
            return new MyAggregateCaseToFilterRule(this);
        }
    }
}
